      ...
      <div className="W_NavBar">
        ...
        <div className="Q_BurgerIcon">
          <Menu right>
            ...
            <a className="A_chapter recipes" href="/zavarka/recipes.html">
              рецепты
            </a>
            <a className="A_chapter media" href="/zavarka/media.html">
              медиа
            </a>
          </Menu>
        </div>
        <nav className="W_NavBarCat">
          <ul className="C_NavBarCat">
            ...
            <li>
              <a className="A_chapter recepies" href="/zavarka/recipes.html">
                рецепты
              </a>
            </li>
            <li>
