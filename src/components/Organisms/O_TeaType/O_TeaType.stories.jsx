...
const mockDataTypeTea = [
  {
    ...
    description: 'Платформа для всех, кто хочет разбираться в чае, уважает культуру чаепития или любит готовить напитки в кругу близких и наедине с собой.',
