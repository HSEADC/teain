...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var M_SearchIcon = document.querySelector('.M_SearchIcon');
  var A_SearchInput = document.querySelector('.A_SearchInput');
  var W_TeaType = document.querySelectorAll('.W_TeaType');
  var O_PreArticle = document.querySelector('.O_PreArticle');
  var W_TextLink = document.querySelector('.W_TextLink');
  var A_Lead = document.querySelector('.A_Lead');
  var O_SearchResult = document.querySelector('.O_SearchResult');
  var M_TeaCards = document.querySelectorAll('.M_TeaCard');
  ...
  M_SearchIcon.addEventListener('mouseleave', function () {
    if (A_SearchInput.value.trim() === '') {
      ...
      A_SearchInput.blur();
      W_TeaType.forEach(function (item) {
  ...
  A_SearchInput.addEventListener('input', function () {
    ...
    M_TeaCards.forEach(function (card) {
      var cardText = card.querySelector('.A_CardTitleHelios').textContent.toLowerCase() + ' ' + card.querySelector('.A_CardTitleVlas').textContent.toLowerCase();
    ...
    var searchResult = document.querySelector('.A_SearchResult');
    if (found) {
      searchResult.innerHTML = 'по запросу "<span id="searchText">' + searchText + '</span>":';
    } else {
      searchResult.innerHTML = 'по запросу "<span id="searchText">' + searchText + '</span>" ничего не найдено';
    }
  });
});
/******/ })()
